...
import breakpoints from '../base-styles/breakpoints'
import gridSpacing from '../base-styles/grid-spacing'
...
const StyledColumn = styled.div`
  ...
  ${({ alignSmall }) =>
    ...
    css`
      @media (max-width: ${breakpoints.S}px) {
        justify-content: ${alignSmall === 'end' ? 'flex-end' : 'center'};
      }
    `}

  @media screen and (min-width: ${breakpoints.XS + 1}px) {
    margin-bottom: ${props =>
  ...
  @media screen and (min-width: ${breakpoints.S + 1}px) {
    margin-bottom: ${props =>
